...
ENV RUSTUP_HOME=/usr/local/rustup \
    ...
    RUSTFLAGS="-C link-arg=-fuse-ld=lld -C target-feature=-avx2,-avx512f,-avx512dq,-avx512vl,-xsavec,-avx512bw,-avx512cd,-xsaveopt,-xsaves,-rtm,-rdseed,-adx -C target-cpu=haswell"
